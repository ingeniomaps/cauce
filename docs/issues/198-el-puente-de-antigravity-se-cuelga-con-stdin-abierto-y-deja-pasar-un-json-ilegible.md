...
La revisión encontró que el lector de entrada se buscaba sólo en la raíz declarada: un proyecto movido o un placeholder sin resolver dejaba al puente sin lector, negando todo, donde los guards todavía encontraban la raíz buscando desde donde corre el puente. Corregido en `edcf7dee`: el lector se busca como la raíz, la declarada primero y después la búsqueda. La prueba fija el cwd en un proceso aparte: desde fuera de todo proyecto sigue negando con su mensaje, y desde adentro lo encuentra.
