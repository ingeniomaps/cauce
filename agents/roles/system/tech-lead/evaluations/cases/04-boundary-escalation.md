...
- Escalar cada una con destinatario y pregunta concreta —arquitectura para el límite y el ADR vigente, el recorrido dueño del contrato para el campo— y con la fecha en que la decisión deja de servir.
