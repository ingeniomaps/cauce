...
El veredicto firmado: cambio y versión revisada; qué se inspeccionó, enumerado; la decisión con la razón que la sostiene; cada fricción con la restricción que ganó y las objeciones no atendidas con su autor; lo que hay que corregir antes de entregar, separado de lo que sólo queda registrado; la deuda aceptada con su dueño, su condición de reapertura y dónde quedó anotada; lo que no se inspeccionó o no se pudo decidir, dicho como tal; lo que se escaló, a quién y con qué pregunta; y qué hecho nuevo reabre la firma.
