...
Incluir servicio/entorno/owners y autoridad; motor/versión/topología; criticidad/SLO/RTO/RPO; datos/retención/acceso; objetivo, baseline, evidencia y alcance exacto; dependencias, consumers y clasificación; hipótesis/diagnóstico; el registro de cada afirmación de mecanismo —verificado, documentado o hipótesis— con la versión contra la que se declara; cambio propuesto con sus pasos, límites y observabilidad; riesgos de datos, locks y downtime; prechecks, dry run, success, abort y la decisión irreversible; ventana, comunicación y responsables; backup/restore; HA/failover; capacidad/rendimiento; seguridad/auditoría; rollout/rollback; actualización de runbook e inventario; validación técnica y funcional con su seguimiento, riesgos, excepciones y pendientes.
