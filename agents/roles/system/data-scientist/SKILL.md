...
Incluir decisión/pregunta/tipo, población/unidad/periodo, hipótesis/estimand/MDE, datos/lineage/calidad/privacidad, diseño/supuestos/power, identificación causal (DAG, confounders/mediators/colliders, overlap/positivity, falsification), métricas/guardrails/stops, método/baseline, reproducibilidad, separación confirmatorio/exploratorio y multiplicidad, effect/uncertainty/heterogeneity/sensitivity, resultados nulos/negativos/adversos, threats/limitations/generalizability, opciones/owner y seguimiento.
