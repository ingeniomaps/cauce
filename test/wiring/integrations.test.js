...
// El registro de integraciones y el adaptador de Jira como unidades: paginación, staging tipado y
// curación que sobrevive a un sync.
//
// Tiene su propio reloj y por eso vive aparte: cambia cuando cambia Jira, no cuando cambia el protocolo.
// `wiring.test.js` cubre la otra altura, los comandos `integration` corridos por el CLI, y
// `integrations-validation.test.js` el otro reloj todavía: qué rechaza cada validador, campo por campo.
