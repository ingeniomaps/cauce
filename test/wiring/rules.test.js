...
test('install declara lo que el bloque de reglas va a pesar en cada agente', () => {
  ...
  // algo nuevo —39,1 con cuatro archivos, 45,9 con R24..R28, 49,4 con lo agregado a R3, R8..R10 y R17— y
  ...
  assert.match(salida.stdout, /claude: el bloque de reglas carga 5 archivo\(s\), 49\.\d KB en cada agente/,
