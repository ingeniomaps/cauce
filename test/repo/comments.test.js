...
// Qué se le exige a un comentario de este repositorio: que sea una oración entera, que esté pegado al
// código que describe, que no cite algo que dejó de existir y que no repita una razón ya escrita en otro
// lado. Es el sujeto que R11 gobierna, y se separó de `repo.test.js` —que juzga la **forma** del código:
// largo de línea, tamaño de archivo, rutas absolutas— cuando aquél cruzó las 500 líneas con las dos
// mitades adentro.
//
// El corpus es el mismo para los dos y por eso `sourceFiles` vive en `test/support/`: copiarlo dejaría
// que una de las dos copias se quedara sin un directorio sin que nada fallara, que es lo que R7 llama
// peor que el archivo largo.
