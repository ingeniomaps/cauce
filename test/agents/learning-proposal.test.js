...
// La propuesta mensual: de qué informes se consolida, qué la firma, y qué pasa al aplicarla.
//
// De dónde sale el material que la abre es de `learning-review.test.js`.
...
const { installedProject, writeSkill, firmarPropuesta } = require('../support/agents-fixtures')
