...
const { tempRoot, run, workflow, workflowStep, workflowCommand } = require('./environment')
...
const { REPO, installedProject, writeSkill, firmarPropuesta } = require('./agents-fixtures')
