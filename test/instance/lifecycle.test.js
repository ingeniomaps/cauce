...
const { MIN_ROLES, tempRoot } = require('../support/environment')
...
test('el paquete publicado sostiene el ciclo completo de una empresa', { timeout: 120000 }, (t) => {
  ...
  // Y lo repuesto queda registrado. Hacen falta dos rutas tocadas y no una: con una sola, un `record`
  // que anulara lo anterior en cada llamada pasaría igual.
  fs.appendFileSync(shippedHook, '\n# y otra mejora\n')
